...
def upload_blob(
    *, container: str, name: str, upload: UploadedFile, content_type: str
    ...
    from modules.file_storage import services as service_package

    # Resolve through the compatibility package so existing test/provider
    # injection points remain stable after moving this module into services/.
    client = service_package._blob_service_client()
