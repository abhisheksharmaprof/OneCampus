"""Repair the next legacy people columns discovered by live API checks."""
...
def repair_columns(apps, schema_editor):
    add_field_if_missing(apps, schema_editor, "StaffProfile", "availability_start_time", None)
    add_field_if_missing(apps, schema_editor, "Student", "religion", "")


class Migration(migrations.Migration):
    dependencies = [("people", "0024_repair_remaining_profile_columns")]
