"""Repair additional people columns missing from legacy databases."""
...
def repair_columns(apps, schema_editor):
    add_field_if_missing(apps, schema_editor, "StaffProfile", "employment_type", "FULL_TIME")
    add_field_if_missing(apps, schema_editor, "Student", "sr_number", "")


class Migration(migrations.Migration):
    dependencies = [("people", "0019_repair_missing_profile_columns")]
