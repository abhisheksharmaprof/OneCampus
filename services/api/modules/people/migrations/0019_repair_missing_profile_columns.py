"""Repair legacy databases missing recently-added people columns."""
...
class Migration(migrations.Migration):
    dependencies = [("people", "0018_repair_missing_student_mother_name")]

    operations = [
        migrations.RunPython(repair_profile_columns, migrations.RunPython.noop),
    ]
