"""Repair legacy databases missing staff limits and student demographic fields."""
...
def repair_columns(apps, schema_editor):
    add_field_if_missing(apps, schema_editor, "StaffProfile", "max_periods_per_day", 6)
    add_field_if_missing(apps, schema_editor, "Student", "gender", "")


class Migration(migrations.Migration):
    dependencies = [("people", "0022_repair_missing_availability_and_birth_date")]
