"""Repair legacy databases missing common people fields."""
...
def repair_columns(apps, schema_editor):
    ...
    add_field_if_missing(apps, schema_editor, "Student", "date_of_birth", None)


class Migration(migrations.Migration):
    dependencies = [("people", "0021_repair_missing_staff_availability_and_aadhar")]
